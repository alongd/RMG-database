...
entry(
    ...
    group =
"""
1 *1 [N,O,S]   u1 px {2,[S,D]}
2 *2 [N,O,S,C] u1 px {1,[S,D]}
""",
    kinetics = None,
)
...
entry(
    ...
    group =
"""
1 *1 S4d             u1 p1 {2,S} {3,D}
2 *2 [O2s,S2s,N3s,C] u1 p2 {1,S}
3    [O2s,S2s,N3s,C] u0 p2 {1,D}
""",
    kinetics = None,
)
...
entry(
    ...
    group =
"""
1 *1 S6d             u1 p0 {2,S} {3,D} {4,D}
2 *2 [O2s,S2s,N3s,C] u1 p2 {1,S}
3    [O2s,S2s,N3s,C] u0 p2 {1,D}
4    [O2s,S2s,N3s,C] u0 p2 {1,D}
""",
    kinetics = None,
)
