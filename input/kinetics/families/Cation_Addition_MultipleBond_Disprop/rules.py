...
entry(
    index = 1,
    label = "Root",
    kinetics = ArrheniusChargeTransfer(A=(5.16116,'m^3/(mol*s)'), n=2.06799, Ea=(23.8116,'kJ/mol'), V0=(0,'V'), alpha=0.5, electrons=-1, T0=(1,'K'), uncertainty=RateUncertainty(mu=-7.39083189245573e-16, var=32.42017750533938, Tref=1000.0, N=7, data_mean=0.0, correlation='Root',), comment="""BM rule fitted to 7 training reactions at node Root
...
entry(
    ...
    kinetics = ArrheniusChargeTransferBM(A=(2454.37,'m^3/(mol*s)'), n=0.869935, w0=(741700,'J/mol'), E0=(74170,'J/mol'), V0=(0,'V'), alpha=0.5, electrons=-1, Tmin=(300,'K'), Tmax=(3000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_4R!H->C_2R!H->N',), comment="""BM rule fitted to 1 training reactions at node Root_4R!H->C_2R!H->N
    Total Standard Deviation in ln(k): 11.540182761524994"""),
    rank = 11,
...
entry(
    ...
    kinetics = ArrheniusChargeTransferBM(A=(0.419384,'m^3/(mol*s)'), n=2.21898, w0=(918800,'J/mol'), E0=(91880,'J/mol'), V0=(0,'V'), alpha=0.5, electrons=-1, Tmin=(300,'K'), Tmax=(3000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_4R!H->C_N-2R!H->N_1R!H->O',), comment="""BM rule fitted to 1 training reactions at node Root_4R!H->C_N-2R!H->N_1R!H->O
    Total Standard Deviation in ln(k): 11.540182761524994"""),
    rank = 11,
...
entry(
    ...
    kinetics = ArrheniusChargeTransferBM(A=(0.162517,'m^3/(mol*s)'), n=2.55635, w0=(716200,'J/mol'), E0=(71620,'J/mol'), V0=(0,'V'), alpha=0.5, electrons=-1, Tmin=(300,'K'), Tmax=(3000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_4R!H->C_N-2R!H->N_N-1R!H->O',), comment="""BM rule fitted to 1 training reactions at node Root_4R!H->C_N-2R!H->N_N-1R!H->O
    Total Standard Deviation in ln(k): 11.540182761524994"""),
    rank = 11,
...
entry(
    ...
    kinetics = ArrheniusChargeTransferBM(A=(0.15629,'m^3/(mol*s)'), n=2.72776, w0=(750800,'J/mol'), E0=(75080,'J/mol'), V0=(0,'V'), alpha=0.5, electrons=-1, Tmin=(300,'K'), Tmax=(3000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_4R!H->C_N-2R!H->N_Ext-3R!H-R_N-1R!H->O',), comment="""BM rule fitted to 1 training reactions at node Root_4R!H->C_N-2R!H->N_Ext-3R!H-R_N-1R!H->O
    Total Standard Deviation in ln(k): 11.540182761524994"""),
    rank = 11,
