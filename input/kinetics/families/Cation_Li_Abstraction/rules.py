...
entry(
    index = 1,
    label = "Root",
    kinetics = ArrheniusChargeTransfer(A=(62.0316,'m^3/(mol*s)'), n=2.36922, Ea=(79.4161,'kJ/mol'), V0=(0,'V'), alpha=0.5, electrons=-1, T0=(1,'K'), uncertainty=RateUncertainty(mu=5.998356318514794e-16, var=505.91409392421104, Tref=1000.0, N=3, data_mean=0.0, correlation='Root',), comment="""BM rule fitted to 3 training reactions at node Root
...
entry(
    index = 2,
    label = "Root_2ClFH->H",
    kinetics = ArrheniusChargeTransferBM(A=(0.16967,'m^3/(mol*s)'), n=3.09275, w0=(329000,'J/mol'), E0=(32900,'J/mol'), V0=(0,'V'), alpha=0.5, electrons=-1, Tmin=(300,'K'), Tmax=(3000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_2ClFH->H',), comment="""BM rule fitted to 1 training reactions at node Root_2ClFH->H
...
entry(
    ...
    kinetics = ArrheniusChargeTransferBM(A=(329.871,'m^3/(mol*s)'), n=2.2276, w0=(531000,'J/mol'), E0=(53100,'J/mol'), V0=(0,'V'), alpha=0.5, electrons=-1, Tmin=(300,'K'), Tmax=(3000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-2ClFH->H_N-2ClF->Cl',), comment="""BM rule fitted to 1 training reactions at node Root_N-2ClFH->H_N-2ClF->Cl
    Total Standard Deviation in ln(k): 11.540182761524994"""),
    rank = 11,
