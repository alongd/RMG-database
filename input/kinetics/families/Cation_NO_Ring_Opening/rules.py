...
entry(
    index = 1,
    label = "Root",
    kinetics = ArrheniusChargeTransfer(A=(58120,'m^3/(mol*s)'), n=1.21832, Ea=(50.6022,'kJ/mol'), V0=(0,'V'), alpha=0.5, electrons=-1, T0=(1,'K'), uncertainty=RateUncertainty(mu=-1.5745685336101335e-15, var=45.176682218361336, Tref=1000.0, N=4, data_mean=0.0, correlation='Root',), comment="""BM rule fitted to 4 training reactions at node Root
...
entry(
    ...
    kinetics = ArrheniusChargeTransferBM(A=(3.92201,'m^3/(mol*s)'), n=2.34419, w0=(303700,'J/mol'), E0=(30370,'J/mol'), V0=(0,'V'), alpha=0.5, electrons=-1, Tmin=(300,'K'), Tmax=(3000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_Ext-2R-R_Ext-5R!H-R_Ext-6R!H-R_N-1NO->O',), comment="""BM rule fitted to 1 training reactions at node Root_Ext-2R-R_Ext-5R!H-R_Ext-6R!H-R_N-1NO->O
    Total Standard Deviation in ln(k): 11.540182761524994"""),
    rank = 11,
