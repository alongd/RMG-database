...
entry(
    index = 1,
    label = "Root",
    kinetics = ArrheniusBM(A=(8.16851e-34,'m^3/(mol*s)'), n=10.8636, w0=(754000,'J/mol'), E0=(-9701.51,'J/mol'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.6599999694238405, var=14.540178389964264, Tref=1000.0, N=6, correlation='Root',), comment="""BM rule fitted to 2 training reactions at node Root
...
entry(
    index = 2,
    label = "Root_6R->C",
    kinetics = ArrheniusBM(A=(0.00451942,'m^3/(mol*s)'), n=0.695918, w0=(754000,'J/mol'), E0=(45910.2,'J/mol'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.05767765801675886, var=1.0206316576672756, Tref=1000.0, N=2, correlation='Root_6R->C',), comment="""BM rule fitted to 2 training reactions at node Root_6R->C
...
entry(
    index = 3,
    label = "Root_N-6R->C",
    kinetics = ArrheniusBM(A=(1.32528e-30,'m^3/(mol*s)'), n=10.0951, w0=(754000,'J/mol'), E0=(-9405.88,'J/mol'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.9414305595600523, var=29.13997483576673, Tref=1000.0, N=4, correlation='Root_N-6R->C',), comment="""BM rule fitted to 2 training reactions at node Root_N-6R->C
...
entry(
    ...
    kinetics = ArrheniusBM(A=(0.636073,'m^3/(mol*s)'), n=0.680875, w0=(754000,'J/mol'), E0=(84756.4,'J/mol'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, correlation='Root_6R->C_Ext-4R-R',), comment="""BM rule fitted to 2 training reactions at node Root_6R->C_Ext-4R-R
...
entry(
    ...
    kinetics = ArrheniusBM(A=(495.477,'m^3/(mol*s)'), n=-0.144487, w0=(754000,'J/mol'), E0=(94192.7,'J/mol'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, correlation='Root_N-6R->C_4R-inRing',), comment="""BM rule fitted to 2 training reactions at node Root_N-6R->C_4R-inRing
    Total Standard Deviation in ln(k): 11.540182761524994"""),
    rank = 11,
