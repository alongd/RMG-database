...
entry(
    index = 10001,
    label = "imipramineCCC(O[O])N(C)C_a <=> imipramineCCC(OON(C)[CH2]_p",
    degeneracy = 6.0,
...
entry(
    index = 10002,
    label = "imipramineCCC(OON(C)[CH2]_r <=> imipramineCCC(O[O])N(C)C_a_p",
    degeneracy = 1.0,
    kinetics=Arrhenius(A=(2.3129e+10, 's^-1'), n=0, Ea=(36.185, 'kJ/mol'),
                       T0=(1, 'K'), Tmin=(275, 'K'), Tmax=(350, 'K')),
    rank = 1,
    longDesc =
u"""
...
entry(
    index = 10003,
    label = "imipramineCCC(O[O])N(C)C_b <=> imipramine[CH]CC(OO)N(C)C_p",
    degeneracy = 2.0,
...
entry(
    index = 10004,
    label = "imipramine[CH]CC(OO)N(C)C_r <=> imipramineCCC(O[O])N(C)C_b_p",
    degeneracy = 1.0,
    kinetics=Arrhenius(A=(3.37771e+11, 's^-1'), n=0, Ea=(64.212, 'kJ/mol'),
                       T0=(1, 'K'), Tmin=(275, 'K'), Tmax=(350, 'K')),
    rank = 1,
    longDesc =
u"""
...
entry(
    index = 10005,
    label = "imipramineCCCN(C)[CH2]_a <=> imipramine_7_membered_ring_rad_p",
    degeneracy = 4.0,
...
entry(
    index = 10006,
    label = "imipramine_7_membered_ring_rad <=> imipramineCCCN(C)[CH2]_a_p",
    degeneracy = 6.0,
...
entry(
    index = 10007,
    label = "NH2CCC(OOj)N(C)C_a <=> NH2CCC(OOH)N(C)CH2j_p",
    degeneracy = 6.0,
    kinetics=Arrhenius(A=(3.3139e+10,'s^-1'), n=0, Ea=(79.3118,'kJ/mol'),
                       T0=(1, 'K'), Tmin=(275, 'K'), Tmax=(350, 'K')),
    rank = 1,
    longDesc =
u"""
...
Optimized TS geometry:
N       2.66127700    0.09459800   -0.20445000
C       1.27461800   -0.23839900    0.12367000
C       0.35965300    0.19199600   -1.01034400
H       1.20930600   -1.31770800    0.26305000
H       0.94317400    0.22538600    1.05898500
C      -1.12184600   -0.03127600   -0.77301400
H       0.49161800    1.25981400   -1.20478400
H       0.63247700   -0.33473300   -1.92787400
N      -1.67347500    0.70112400    0.37654600
H      -1.68824200    0.29692300   -1.64919400
C      -1.99232000   -0.09563600    1.47060100
C      -2.66193400    1.70525600    0.01645900
H      -1.15577300   -0.67044700    1.86764600
H      -2.58930500    0.41307800    2.22037900
H      -2.63209100   -1.04203000    0.86033700
H      -2.89792000    2.30798200    0.89154400
H      -3.58135400    1.24150100   -0.35736800
H      -2.25644500    2.35528400   -0.75761200
O      -1.30482700   -1.42451300   -0.60233300
O      -2.63422600   -1.70930000   -0.26996800
H       3.25899100   -0.20063900    0.55799300
H       2.74995400    1.10377400   -0.25147900
""",
)

entry(
    index = 10008,
    label = "NH2CCC(OOH)N(C)CH2j <=> NH2CCC(OOj)N(C)C_a_p",
    degeneracy = 1.0,
    kinetics=Arrhenius(A=(1.52448e+10,'s^-1'), n=0, Ea=(37.0943,'kJ/mol'),
                       T0=(1, 'K'), Tmin=(275, 'K'), Tmax=(350, 'K')),
    rank = 1,
    longDesc =
u"""
...
entry(
    index = 10009,
    label = "NH2CCC(OOj)N(C)C_b <=> NH2CHjCC(OOH)N(C)C_p",
    degeneracy = 2.0,
    kinetics=Arrhenius(A=(2.12396e+10,'s^-1'), n=0, Ea=(64.4517,'kJ/mol'),
                       T0=(1, 'K'), Tmin=(275, 'K'), Tmax=(350, 'K')),
    rank = 1,
    longDesc =
u"""
...
Optimized TS geometry:
N       2.28208100    0.07640000    0.67555800
C       1.43123300   -0.85576400    0.06115700
C       0.04527700   -0.96918700    0.65116600
H       1.12613100   -0.45829600   -1.08359100
H       1.92944000   -1.80817800   -0.11037400
C      -0.88726800    0.10064200    0.07498200
H      -0.35605700   -1.95454500    0.42126100
H       0.08252900   -0.85452400    1.73650500
N      -2.20565400    0.10016000    0.61027200
H      -0.45390300    1.09340300    0.22706600
C      -2.94827000   -1.14756900    0.47108000
C      -2.99716500    1.22850600    0.13596600
H      -3.89857400   -1.04465600    0.99546500
H      -3.16766700   -1.40245700   -0.57314400
H      -2.40983600   -1.97620200    0.92682600
H      -3.90169300    1.31360300    0.73930100
H      -3.29976500    1.12673600   -0.91381700
H      -2.42698100    2.15190600    0.24186600
O      -0.93252600   -0.11035100   -1.36105100
O       0.30132900    0.22818800   -1.90139400
H       1.85115300    0.97381500    0.85333900
H       3.17318600    0.18474100    0.21358100
""",
)

entry(
    index = 10010,
    label = "NH2CHjCC(OOH)N(C)C <=> NH2CCC(OOj)N(C)C_b_p",
    degeneracy = 1.0,
    kinetics=Arrhenius(A=(1.25823e+11,'s^-1'), n=0, Ea=(36.1972,'kJ/mol'),
                       T0=(1, 'K'), Tmin=(275, 'K'), Tmax=(350, 'K')),
    rank = 1,
    longDesc =
u"""
...
entry(
    index = 10011,
    label = "imipramine_rad_5 <=> imipramine_rad_2_p",
    degeneracy = 2.0,
...
entry(
    index = 10012,
    label = "imipramine_rad_2 <=> imipramine_rad_5_p",
    degeneracy = 6.0,
...
entry(
    index = 10014,
    label = "imipramine_5_peroxy <=> imipramine_5_peroxide_p",
    degeneracy = 2.0,
...
entry(
    index = 10015,
    label = "imipramine_5_peroxide <=> imipramine_5_peroxy_p",
    degeneracy = 1.0,
    kinetics = Arrhenius(A=(2.01211e+10,'s^-1'), n=0, Ea=(24.0802,'kJ/mol'),
                         T0=(1,'K'), Tmin=(275,'K'), Tmax=(350,'K')),
    rank = 1,
    longDesc =
u"""
...
entry(
    index = 10016,
    label = "NCCCN(C)COOj <=> NCCCjN(C)COOH_p",
    degeneracy = 2.0,
...
entry(
    index = 10017,
    label = "NCCCjN(C)COOH <=> NCCCN(C)COOj_p",
    degeneracy = 1.0,
...
entry(
    index = 10018,
    label = "NCCC(OOj)N(C)C <=> NCCC(OOH)N(C)Cj_p",
    degeneracy = 6.0,
...
entry(
    index = 10019,
    label = "NCCC(OOH)N(C)Cj <=> NCCC(OOj)N(C)C_p",
    degeneracy = 1.0,
