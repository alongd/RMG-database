...
Prepared by Alon Grinberg Dana, last updated: May 15, 2017
Notes:
...
* N2H4 + N2O4 (92-124)
* CH3NO2 (125-136)
* Thermal de-NOx (137-172)
* NO2 decomposition (173-181)
* NOx (182-213)
* HCN (214-220)
* SOx (221-246)
* COS (247-253)
...
entry(
    ...
    degeneracy = 1,
    kinetics = ThirdBody(
        arrheniusLow = Arrhenius(A=(8.90e+14, 'cm^3/(mol*s)','+|-',1.78e+14), n=0, Ea=(62140, 'cal/mol'), T0 = (1, 'K'), Tmin=(2012, 'K'), Tmax=(2204, 'K'))),
    shortDesc = u"""[Friedrichs2012]""",
    longDesc =
u"""
Part of the "Prompt NO, NCN subset" mechanism
