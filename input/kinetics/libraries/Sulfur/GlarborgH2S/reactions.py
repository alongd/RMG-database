    ...
    kinetics = MultiArrhenius(
        arrhenius = [
            ...
            Arrhenius(
                ...
                Ea = (3583, 'cal/mol'),
                T0 = (1, 'K'),
                shortDesc = 'Sendt K Haynes BS PROC COMBUST INST 31 257-265 2007',
            ),
        ],
    ),
)
    ...
    kinetics = MultiArrhenius(
        arrhenius = [
            Arrhenius(
                ...
                Ea = (19013, 'cal/mol'),
                T0 = (1, 'K'),
                shortDesc = 'Zhou TST (2009) (quArtet TS); Ea-2.5 kcal/mol (pw)',
            ),
            Arrhenius(
                A = (29, 'cm^3/(mol*s)'),
                n = 3.2,
                Ea = (14529, 'cal/mol'),
                T0 = (1, 'K'),
                shortDesc = 'pw (PM 2015) (doublet TS)',
            ),
        ],
    ),
)
    ...
    kinetics = MultiArrhenius(
        arrhenius = [
            ...
            Arrhenius(
                ...
                Ea = (261, 'cal/mol'),
                T0 = (1, 'K'),
                shortDesc = 'Sendt K Jazbec M Haynes BS PCI 29:2439-2446 2002\nCR Zhou K Sendt BS Haynes J. Phys. Chem. A 2009, 112, 3239-3247',
            ),
        ],
    ),
)
    ...
    kinetics = MultiArrhenius(
        arrhenius = [
            ...
            Arrhenius(
                ...
                Ea = (-56, 'cal/mol'),
                T0 = (1, 'K'),
                shortDesc = 'CR Zhou K Sendt BS Haynes J. Phys. Chem. A 2009, 112, 3239-3247',
            ),
        ],
    ),
)
