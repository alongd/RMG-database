...
entry(
    index = 35,
    label = "cyanoisopropylOO + cyanoisopropylOO <=> cyanoisopropylOO_mer",
    degeneracy = 1.0,
    kinetics = Arrhenius(A=(5.3e+11,'cm^3/(mol*s)'), n=0.35, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(275,'K'),
                         Tmax=(350,'K')),
    longDesc =
"""
RMG's estimate is:
...
Here we increased it by an order of magnitude
""",
)
