...
Using this library requires that N2 will be present in the RMG job (even as nonreactive) since it is defined as a
specific third body collider in the `SO2 + O (+N2) <=> SO3 (+N2)` reaction.
