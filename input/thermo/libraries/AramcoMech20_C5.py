...
name = "AramcoMech20_C5"
shortDesc = u"AramcoMech20_C5"
longDesc = u"""
ARAMCO 2.0
"""
...
H6W/94
Low T polynomial Tmin changed from 300.0 to 298.0 K when importing to RMG.
Duplicate of species C4H5-I (i.e. same molecular structure according to RMG)
C=C=[C]C
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(coeffs=[4.66263,0.0389775,-1.12816e-05,-2.66551e-09,1.40115e-12,1470.87,8.21346], Tmin=(298,'K'), Tmax=(1364,'K')),
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(coeffs=[1.23497,0.0548299,-2.85379e-05,6.14802e-09,-2.41162e-13,-17064.4,28.4296], Tmin=(298,'K'), Tmax=(1396,'K')),
            NASAPolynomial(coeffs=[16.435,0.0248732,-8.43959e-06,1.30322e-09,-7.53261e-14,-22895.7,-55.1681], Tmin=(1396,'K'), Tmax=(5000,'K')),
        ],
        Tmin = (298,'K'),
        Tmax = (5000,'K'),
    ),
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(coeffs=[2.16094,0.0526897,-2.56801e-05,4.72181e-09,-1.32098e-14,-19356.4,20.7681], Tmin=(298,'K'), Tmax=(1384,'K')),
            NASAPolynomial(coeffs=[16.9552,0.0250397,-8.62898e-06,1.34632e-09,-7.8377e-14,-25255.6,-61.2549], Tmin=(1384,'K'), Tmax=(5000,'K')),
        ],
        Tmin = (298,'K'),
        Tmax = (5000,'K'),
    ),
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(coeffs=[-1.66279,0.0747657,-6.14804e-05,2.69358e-08,-4.78921e-12,-16129.8,37.5225], Tmin=(298,'K'), Tmax=(1408,'K')),
            NASAPolynomial(coeffs=[17.6376,0.0233185,-7.78464e-06,1.18858e-09,-6.81463e-14,-22196.4,-63.8737], Tmin=(1408,'K'), Tmax=(5000,'K')),
        ],
        Tmin = (298,'K'),
        Tmax = (5000,'K'),
    ),
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(coeffs=[1.20883,0.0778603,-6.16377e-05,2.60507e-08,-4.52025e-12,-36652.5,26.4079], Tmin=(298,'K'), Tmax=(1391,'K')),
            NASAPolynomial(coeffs=[21.9522,0.0248782,-8.44297e-06,1.30372e-09,-7.53469e-14,-43440.4,-83.4516], Tmin=(1391,'K'), Tmax=(5000,'K')),
        ],
        Tmin = (298,'K'),
        Tmax = (5000,'K'),
    ),
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(coeffs=[2.71005,0.072807,-5.37415e-05,2.08816e-08,-3.34176e-12,-38027.7,18.5553], Tmin=(298,'K'), Tmax=(1395,'K')),
            NASAPolynomial(coeffs=[22.8866,0.0240778,-8.16958e-06,1.26165e-09,-7.29326e-14,-44876.5,-89.2416], Tmin=(1395,'K'), Tmax=(5000,'K')),
        ],
        Tmin = (298,'K'),
        Tmax = (5000,'K'),
    ),
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(coeffs=[-0.139599,0.0839733,-7.03813e-05,3.10327e-08,-5.52298e-12,-34280.1,33.8678], Tmin=(298,'K'), Tmax=(1406,'K')),
            NASAPolynomial(coeffs=[22.2414,0.0243139,-8.17987e-06,1.25568e-09,-7.22731e-14,-41306,-83.6981], Tmin=(1406,'K'), Tmax=(5000,'K')),
        ],
        Tmin = (298,'K'),
        Tmax = (5000,'K'),
    ),
...
1/22/ 9 WKM
Low T polynomial Tmin changed from 300.0 to 298.0 K when importing to RMG.
Duplicate of species B13DE2MJ (i.e. same molecular structure according to RMG)
[CH2]C(=C)C=C
...
Z&B
Low T polynomial Tmin changed from 300.0 to 298.0 K when importing to RMG.
Duplicate of species CVCCJCVC (i.e. same molecular structure according to RMG)
[CH2]C=CC=C
